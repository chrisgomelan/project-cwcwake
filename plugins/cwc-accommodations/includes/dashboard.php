...
function cwc_render_booking_dashboard() {
	...
	<div class="wrap cwc-dash">
		<h1 class="cwc-dash__title">
			<span class="dashicons dashicons-performance" style="font-size: 32px; width: 32px; height: 32px; margin-right: 8px;"></span>
			Booking Dashboard
		</h1>
			...
			<div class="cwc-dash__modal-container">
				...
				<div class="cwc-dash__modal-body">
					<div class="cwc-dash__modal-info">
						...
						<p><strong>Guest:</strong> <span id="modal-guest-name"></span> (<span id="modal-guest-email"></span>)</p>
					</div>
					...
					<div class="cwc-dash__modal-field" id="modal-note-wrap">
						...
						<textarea id="modal-admin-note" rows="3" placeholder="e.g. Your room has been verified and is ready for your arrival."></textarea>
					</div>
	...
	<div class="cwc-dash__card">
		<div class="cwc-dash__card-header cwc-dash__card-header--with-actions">
			...
			<div class="cwc-dash__filters">
				<div class="cwc-dash__search-wrap">
					...
					<input type="text" id="cwc-booking-search" class="cwc-dash__search-input" placeholder="Search ref, name, email, phone...">
				</div>
		...
		<?php if ( empty( $bookings ) ) : ?>
			<div class="cwc-dash__empty">
				<span class="dashicons dashicons-clipboard" style="font-size: 48px; width: 48px; height: 48px; color: #cbd5e1; margin-bottom: 16px;"></span>
							...
							<tr class="cwc-dash__row-item" 
								...
								<td>
									<div class="cwc-dash__date-cell">
										<span class="cwc-dash__date-in"><?php echo esc_html( date( 'M j', strtotime( $b['checkin'] ) ) ); ?></span>
								...
								<td>
									<span class="cwc-dash__payment-badge cwc-dash__payment-badge--<?php echo esc_attr( $b['payment_status'] ); ?>">
								...
								<td class="cwc-dash__td-actions">
									<div class="cwc-dash__actions-menu">
										...
										<div class="cwc-dash__actions-dropdown">
											<button class="js-action-change-status" 
													data-id="<?php echo esc_attr( $b['id'] ); ?>"
	...
	<div class="cwc-dash__card">
		<div class="cwc-dash__card-header cwc-dash__card-header--with-actions">
			...
			<div class="cwc-dash__filters">
				<div class="cwc-dash__search-wrap">
					<span class="dashicons dashicons-search cwc-dash__search-icon"></span>
					<input type="text" id="cwc-guest-search" class="cwc-dash__search-input" placeholder="Search name, ref, email...">
				</div>
			</div>
		</div>
		<?php if ( empty( $bookings ) ) : ?>
			<div class="cwc-dash__empty">
				<span class="dashicons dashicons-groups" style="font-size: 48px; width: 48px; height: 48px; color: #cbd5e1; margin-bottom: 16px;"></span>
									...
									<div class="cwc-dash__guest-cell">
										...
										<?php if ( $has_companions ) : ?>
											<span class="cwc-dash__companion-badge">
												+<?php echo esc_html( $comp_count ); ?> companion<?php echo $comp_count > 1 ? 's' : ''; ?>
											</span>
										<?php endif; ?>
									</div>
								</td>
							...
							<?php if ( $has_companions ) : ?>
								<?php foreach ( $b['guests'] as $g ) : ?>
									<tr class="cwc-dash__tr--companion cwc-dash__companion-row cwc-dash__row-item" 
										...
										<td>
											<span class="cwc-dash__type-badge cwc-dash__type-badge--<?php echo esc_attr( strtolower( $g['type'] ?? 'adult' ) ); ?>">
	...
	<div class="cwc-dash__card">
		<div class="cwc-dash__card-header cwc-dash__card-header--with-actions">
			...
			<div class="cwc-dash__filters">
				<div class="cwc-dash__search-wrap">
					<span class="dashicons dashicons-search cwc-dash__search-icon"></span>
					<input type="text" id="cwc-payment-search" class="cwc-dash__search-input" placeholder="Search Transaction ID, Ref, Name...">
				</div>
			</div>
		</div>
		<?php if ( empty( $bookings ) ) : ?>
			<div class="cwc-dash__empty">
				<span class="dashicons dashicons-money-alt" style="font-size: 48px; width: 48px; height: 48px; color: #cbd5e1; margin-bottom: 16px;"></span>
								...
								<td class="cwc-dash__td-actions">
									<div class="cwc-dash__actions-menu">
										...
										<div class="cwc-dash__actions-dropdown cwc-dash__actions-dropdown--right">
											<button class="js-action-update-payment" 
													data-id="<?php echo esc_attr( $b['id'] ); ?>"
													data-status="paid">
												Mark as Paid
											</button>
	...
	<div class="cwc-dash__grid-2">
				...
				<?php foreach ( $rooms as $room_post ) :
					...
					<div class="cwc-dash__room-card">
						...
						<div class="cwc-dash__room-meta">
							<span><?php echo esc_html( $active ); ?> booked</span>
		...
		<div class="cwc-dash__card">
			...
			<?php if ( empty( $upcoming ) ) : ?>
				<div class="cwc-dash__empty">
					<span class="dashicons dashicons-calendar-alt" style="font-size: 48px; width: 48px; height: 48px; color: #cbd5e1; margin-bottom: 16px;"></span>
					...
					<?php foreach ( $upcoming as $u ) : ?>
						<div class="cwc-dash__schedule-item">
							...
							<div class="cwc-dash__schedule-info">
								...
								<small><?php echo esc_html( $u['room'] ); ?> · <?php echo esc_html( $u['checkin'] ); ?> → <?php echo esc_html( $u['checkout'] ); ?></small>
							</div>
	...
	<div class="cwc-dash__grid-2">
					...
					<div class="cwc-dash__chart-col">
						<div class="cwc-dash__chart-bar-wrap">
							<div class="cwc-dash__chart-bar" style="height: <?php echo esc_attr( $pct ); ?>%"
								...
								<?php if ( $m['revenue'] > 0 ) : ?>
									<span class="cwc-dash__chart-val">₱<?php echo esc_html( number_format( $m['revenue'] / 1000, 1 ) ); ?>k</span>
								<?php endif; ?>
							</div>
						</div>
		...
		<div class="cwc-dash__card">
			...
			<?php if ( empty( $room_counts ) ) : ?>
				<div class="cwc-dash__empty"><p>No data yet.</p></div>
			<?php else : ?>
					...
					foreach ( $room_counts as $room_name => $cnt ) :
						...
						<div class="cwc-dash__breakdown-row">
							<div class="cwc-dash__breakdown-label">
								...
								<span class="cwc-dash__breakdown-stats"><?php echo esc_html( $cnt ); ?> bookings · ₱<?php echo esc_html( number_format( $rev, 2 ) ); ?></span>
							</div>
		...
		<div class="cwc-dash__card">
			...
			<?php if ( empty( $payment_counts ) ) : ?>
				<div class="cwc-dash__empty"><p>No payment data.</p></div>
			<?php else : ?>
