...
$wrapper = get_block_wrapper_attributes( [ 'class' => 'cwc-timeline' ] );
?>
...
<section <?php echo $wrapper; ?>>
	...
	<div class="cwc-timeline__track">
		...
		?>
			<div class="cwc-timeline__row cwc-timeline__row--<?php echo $align; ?>">
				...
				<div class="cwc-timeline__card">
					...
					<span class="cwc-timeline__year"><?php echo esc_html( $m['year'] ); ?></span>
					<?php if ( ! empty( $m['title'] ) ) : ?>
						<span class="cwc-timeline__milestone"> – <?php echo esc_html( $m['title'] ); ?></span>
					<?php endif; ?>
					<div class="cwc-timeline__card-body">
						<?php echo nl2br( esc_html( $m['desc'] ) ); ?>
					</div>
				</div>

				<div class="cwc-timeline__image">
					<img src="<?php echo esc_url( $m['image'] ); ?>" alt="<?php echo esc_attr( $m['year'] . ' ' . $m['title'] ); ?>" loading="lazy">
				</div>
			</div>
		<?php endforeach; ?>
	</div>
