...
if (empty($cards)) {
	$cards = array(
		array(
			...
			'desc' => 'CWC practices responsible tourism through eco-conscious operations, resource preservation, and active support for local businesses.',
		),
		array(
			'icon' => 'local-employment.svg',
			'title' => 'Local Employment',
			'desc' => 'CWC provides hundreds of local jobs in operations, hospitality, and maintenance, directly uplifting livelihoods within the community.',
		),
		array(
			'icon' => 'youth-sports-dev.svg',
			'title' => 'Youth & Sports Development',
			'desc' => 'CWC makes wakeboarding accessible to aspiring athletes, nurturing young talent through training, competition exposure, and opportunities to grow.',
		),
	);
}
	...
	<div class="cwc-empower__body">
		...
		<div class="cwc-empower__media">
			...
			<div class="cwc-empower__image-wrap">
				<?php if ('' !== $image): ?>
					<img class="cwc-empower__image" src="<?php echo esc_url($image); ?>"
			...
			<?php foreach ($cards as $card): ?>
				...
				<div class="cwc-empower__card">
					<div class="cwc-empower__icon-wrap">
						<?php if ('' !== $icon_src): ?>
							<img src="<?php echo esc_url($icon_src); ?>" alt="<?php echo esc_attr($card_title); ?>"
								class="cwc-empower__icon-img">
						<?php endif; ?>
					</div>
