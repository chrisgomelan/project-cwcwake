...
<div <?php echo $wrapper_attrs; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
	data-source="<?php echo esc_attr($booking_data_source); ?>">
	<!-- ─── Incomplete Selection Message (Hidden by default) ─── -->
	<div id="bf-incomplete-message" class="bf-inner-container"
		style="display: none; text-align: center; padding: 100px 20px;">
			...
			<div class="bf-layout">
				...
				<div class="bf-panel-wrap">
					...
					<div class="bf-panel bf-panel--guest is-active" id="bf-step-guest">
						...
						<p class="bf-panel__desc">Guest names must match the valid ID which will be used at check-in.
						</p>
						...
						<div class="bf-panel__section-header">
							...
							<div class="bf-panel__section-controls">
								...
								<button class="bf-panel__add-guest" id="bf-add-guest" type="button">
									<img src="/wp-content/uploads/2026/04/add-new-guest.svg" alt="" width="24"
										height="24">
									Add New Guest
								</button>
							</div>
						...
						<div class="bf-field">
							...
							<input type="text" class="bf-field__input" id="bf-fullname"
								placeholder="Last Name, First Name" required>
							<p class="bf-field__note">All booking confirmations, updates, and important travel details
								will
						...
						<div class="bf-field-row">
							<div class="bf-field bf-field--half">
								...
								<div class="bf-field__input-wrap bf-field__input-wrap--icon">
									<img src="/wp-content/uploads/2026/04/mail-envelope.svg" alt=""
										class="bf-field__icon" width="20" height="20">
					...
					<div class="bf-panel bf-panel--payment" id="bf-step-payment">
						...
						<div class="bf-payment-methods">
							...
							<label class="bf-payment-methods__option">
								<input type="radio" name="bf_payment_method" value="paymaya">
								<img src="/wp-content/uploads/2026/04/kind.webp" alt="PayMaya" height="40">
							</label>
							<label class="bf-payment-methods__option">
							...
							<label class="bf-payment-methods__option">
								...
								<img src="/wp-content/uploads/2026/04/bank-transfer.webp" alt="Bank Transfer"
									height="40">
							</label>
						</div>
						...
						<div class="bf-card-form" id="bf-card-form">
							...
							<div class="bf-field">
								<label class="bf-field__label">Card Holder Name <span
										class="bf-field__req">*</span></label>
						...
						<div class="bf-gcash-qr" id="bf-gcash-qr">
							...
							<p class="bf-panel__desc">Please scan the QR code using your GCash app to complete your
								payment
								quickly and securely. Once done, kindly keep a screenshot of your transaction for
								reference.
							</p>
							<div class="bf-gcash-qr__image">
								<img src="/wp-content/uploads/2026/04/gcash-qr-code.webp" alt="GCash QR Code"
				...
				<aside class="bf-summary" id="bf-summary">
					...
					<div class="bf-summary__header">
						...
						<div class="bf-summary__mobile-quick" id="bf-summary-mobile-quick">
							<h3 class="bf-summary__mobile-room" id="bf-summary-mobile-room">
								<?php echo esc_html($first_room['title']); ?> Room
							</h3>
							<div class="bf-summary__mobile-dates">
								<span
									id="bf-summary-mobile-checkin"><?php echo esc_html($checkin_val ?: '08/14/2026'); ?></span>
								— <span
									id="bf-summary-mobile-checkout"><?php echo esc_html($checkout_val ?: '08/19/2026'); ?></span>
							</div>
							<div class="bf-summary__mobile-total">
								Total: <span id="bf-summary-mobile-price">₱
					...
					<div class="bf-summary__content" id="bf-summary-content">
						...
						<div class="bf-summary__details" id="bf-summary-details">
							<div class="bf-summary__section-header">
								...
								<button class="bf-summary__edit-link" data-modal="personal-info" type="button">
									<img src="/wp-content/uploads/2026/04/pencil-edit.svg" alt="" width="16"
										height="16">
									Edit
								</button>
							</div>
						...
						<div class="bf-summary__selected-room">
							...
							<div class="bf-summary__amenities" id="bf-summary-amenities">
								...
								<?php endforeach; ?>
								<span class="bf-summary__amenity">
									<img src="/wp-content/uploads/2026/04/max-people-icon.svg" alt="" width="16"
										height="16">
									Max <span
										id="bf-summary-capacity"><?php echo esc_html($first_room['capacity']); ?></span>
									People
								</span>
							</div>
						</div>
						...
						<div class="bf-summary__price-breakdown" style="font-size: 14px; color: #475569;">
							...
							<?php if ($nights_count > 0): ?>
								<div id="bf-summary-nights" class="bf-summary__nights-row"
									style="display:flex;justify-content:space-between; padding: 0 !important;">
									<span>Duration</span>
									<strong><?php echo esc_html($nights_count); ?>
										night<?php echo $nights_count > 1 ? 's' : ''; ?></strong>
								</div>
							<?php endif; ?>
						</div>
